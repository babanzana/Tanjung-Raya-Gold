...
//   ActivityIndicator,
// } from "react-native";
// import { getAllProducts, saveTransaction } from "../../../../../firebase";
...
//   useEffect(() => {
//     // Load products from Firebase instead of dummy data
...
//         Alert.alert("Error", "Gagal memuat data produk. Silakan coba lagi.");
//       } finally {
...
export const PenjualanOfflineScreen = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      // Update product stock in Firebase for each sold item
      const stockUpdatePromises = selectedProducts.map((item) =>
